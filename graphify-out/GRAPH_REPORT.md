# Graph Report - gpq  (2026-09-08)

## Corpus Check
- 124 files · ~153,487 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3123 nodes · 8213 edges · 110 communities (100 shown, 7 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 197 edges (avg confidence: 0.85)
...
### Community 3 - "Harness"
Cohesion: 0.06
Nodes (56): CatalogServiceClient, ClientConfig, AdminCli, chat_parameters(), collect_sse_json(), database_url_for(), database_url_with_credentials(), enroll_worker() (+48 more)

### Community 4 - "PoolConfig"
Cohesion: 0.05
Nodes (83): check_device_overlap(), duration_secs(), ensure_state_dir(), parses_custom_node_versions(), parses_full_sample(), parses_mlx_dspark_pool(), PoolConfig, rejects_backend_url_query_and_fragment() (+75 more)
...
Cohesion: 0.07
Nodes (62): ChatMessage, build_chat_request(), build_chat_request_forces_stream_and_passes_through_fields(), build_chat_request_injects_seed_overriding_existing(), build_chat_request_omits_seed_when_absent(), build_chat_request_rejects_non_object_parameters(), ChatChunk, ChatChunkChoice (+54 more)
...
Cohesion: 0.19
Nodes (30): ArtifactRow, ArtifactStoreError, begin_delivery(), commit_offset(), create_inline_input(), create_input(), decode_u64(), delete_inputs_for_generation() (+22 more)
...
Cohesion: 0.11
Nodes (26): FailureKind, download_input(), failure_kind_to_proto(), fetch_inputs(), manifest_from_proto(), media_kind_from_proto(), modality_from_proto(), output_publish_strategy() (+18 more)
...
Cohesion: 0.05
Nodes (73): append(), append_attempt_created(), EventKind, EventRow, latest(), load_since(), AttemptId, DateTime (+65 more)

### Community 19 - "backend/comfy.rs"
Cohesion: 0.05
Nodes (39): apply_parameters(), apply_parameters_overrides_addressed_node_input(), apply_parameters_places_seed_at_reserved_pointer(), apply_parameters_rejects_malformed_pointer(), apply_parameters_rejects_missing_portable_placeholder(), apply_parameters_rejects_unknown_node_id(), apply_parameters_replaces_portable_placeholders(), apply_parameters_skips_seed_without_pointer() (+31 more)
...
Cohesion: 0.10
Nodes (30): ArtifactPlacement, artifact_placement_from_proto(), artifact_placement_round_trips_through_proto(), artifact_placement_to_proto(), backend_kind_maps_every_domain_variant(), backend_kind_to_proto(), duration_from_proto(), duration_round_trips_through_proto() (+22 more)

### Community 25 - "WorkerRegistry"
Cohesion: 0.15
Nodes (19): online_workers_is_scoped_to_its_tenant(), registered_worker_is_online_and_reachable(), Arc, Drop, HashMap, Mutex, RemoteMessage, Sender (+11 more)
...
Cohesion: 0.22
Nodes (25): ArtifactChunkData, ArtifactHandle, delete_is_idempotent(), expire_removes_only_artifacts_past_ttl(), manifest(), open_for_read_rejects_an_offset_past_the_manifest(), open_store(), publish_rejects_digest_mismatch_and_leaves_no_directory() (+17 more)
...
### Community 39 - "capability.rs"
Cohesion: 0.14
Nodes (28): BTreeSet, accelerator_memory_boundary_is_inclusive(), extra_models_and_custom_nodes_do_not_block_admission(), IncapableReason, missing_custom_node_reports_no_installed_version(), mlx_dspark_admits_llm_model_requirements(), oom_marking_removes_the_slot_from_candidates(), raw_comfy_prompts_require_the_adapter_flag() (+20 more)
...
Cohesion: 0.10
Nodes (29): build_lease_assignment(), duration_from_micros_round_trips(), duration_from_negative_micros_falls_back_to_zero(), eligible_pool_is_bounded_by_its_advertised_free_slots(), known_tenants(), lease_target_fields(), leased_output_key(), model_target_leaves_workflow_fields_unset() (+21 more)
...
Cohesion: 0.10
Nodes (16): data_url_decodes_base64(), data_url_decodes_percent_encoded_text(), failure_status_and_code(), ip_literal_host_public_address_is_accepted(), is_publicly_routable(), is_publicly_routable_v4(), is_publicly_routable_v6(), resolve_safe_addrs() (+8 more)

### Community 45 - "backend/mod.rs"
Cohesion: 0.13
Nodes (26): BackendCapabilities, build(), classify_transport_error(), client_error_status_normalizes_to_internal(), connect_failure_normalizes_to_backend_crashed(), ExecutionRequest, http_client(), InputArtifact (+18 more)

### Community 46 - "BackendError"
Cohesion: 0.21
Nodes (28): apply_override(), checkpoint_names(), classify_prompt_validation_error(), collect_raw_output_refs(), extract_output_entries(), internal_error(), parse_raw_prompt(), plan_raw_outputs() (+20 more)
...
Cohesion: 0.24
Nodes (13): lease_expires_forty_five_seconds_after_now(), lease_expiry_from(), DateTime, Utc, assign(), DateTime, Result, TenantId (+5 more)

### Community 49 - "src/models.rs"
Cohesion: 0.13
Nodes (45): CacheFile, Hasher, streaming_matches_one_shot(), cache_hits_for_an_unchanged_file(), cache_key(), cache_misses_when_content_and_size_change(), CacheEntry, CacheKey (+37 more)
...
### Community 59 - "ExecutionContext"
Cohesion: 0.10
Nodes (37): decode_comfy_prompt(), DirGuard, discard_published_outputs(), execute(), execution_timeout_duration(), ExecutionContext, ExecutionOutcome, handle_event() (+29 more)
...
Cohesion: 0.09
Nodes (16): hash(), ExecutionTarget, ContentHash, digest_matches_known_vector(), round_trips_through_hex(), D, Display, Err (+8 more)
...
Cohesion: 0.09
Nodes (56): canonical_uuid(), ComfyError, error_response(), ErrorBody, ErrorDetail, get_history(), get_history_prompt(), get_prompt() (+48 more)
...
Cohesion: 0.16
Nodes (12): DevicePoolId, JoinHandle, Receiver, Self, Sender, WorkerId, run(), sample_capability() (+4 more)

### Community 87 - "objectstore.rs"
Cohesion: 0.28
Nodes (20): block_on(), F, Output, chat_parameters(), create_and_upload_input(), create_input_artifact_presigns_upload_and_is_downloadable(), create_input_artifact_rejects_oversized_manifest(), expiry_sweep_transitions_and_deletes_past_due_object_store_artifact() (+12 more)

### Community 88 - "ArtifactManifest"
Cohesion: 0.10
Nodes (14): ArtifactManifest, manifest(), ManifestMismatch, MediaKind, Result, Self, String, verification_accepts_matching_bytes() (+6 more)
...
### Community 94 - "gpq-domain/src/state.rs"
Cohesion: 0.14
Nodes (6): ArtifactState, Result, Self, terminal_attempt_states_are_final(), TransitionError, artifact_state_to_proto()
...
### Community 97 - "src/cli.rs"
Cohesion: 0.23
Nodes (18): Cli, Command, CancellationToken, Command, Option, Result, String, Uuid (+10 more)

### Community 98 - "LocalArtifactStore"
Cohesion: 0.24
Nodes (10): LocalArtifactStore, ArtifactId, AttemptId, DateTime, Duration, PathBuf, Result, Self (+2 more)
...
Cohesion: 0.43
Nodes (8): await_terminal_generation(), fetch_generation_row(), GenerationId, Receiver, Result, TenantId, store_inline_input_artifact(), tenant_settings()
...
### Community 104 - "authenticate"
Cohesion: 0.18
Nodes (11): authenticate(), priority_from_wire(), priority_from_wire_accepts_the_full_range(), ConnectError, Future, Output, RequestContext, Result (+3 more)

### Community 105 - ".from_row"
Cohesion: 0.25
Nodes (6): decode(), decode_rejects_unknown_state_name(), Err, Self, T, PgRow

### Community 106 - "ArtifactDirection"
Cohesion: 0.40
Nodes (4): ArtifactDirection, Display, Formatter, FromStr

### Community 107 - "recv_or_pending"
Cohesion: 0.40
...
- **Why does `AppState` connect `AppState` to `gpq-remote/src/artifacts.rs`, `native/generation.rs`, `tenants.rs`, `chat.rs`, `GenerationEvent`, `.register_workflow_version`, `responses.rs`, `transfer.rs`, `gpq-remote/src/session.rs`, `native/mod.rs`, `WorkerRegistry`, `admission.rs`, `record_accepted_result`, `images.rs`, `scheduler.rs`, `Db`, `openai/mod.rs`, `gpq-remote/src/config.rs`, `TenantId`, `.new`, `.enroll`, `resolve_and_store_images`, `.new`, `Modality`, `TenantId`, `ws.rs`, `comfy/mod.rs`, `http.rs`, `SchedulerHandle`, `Result`, `authenticate`, `recv_or_pending`, `parse_uuid_id`, `settle_attempt_failure`?**
  _High betweenness centrality (0.280) - this node is a cross-community bridge._
- **Why does `ContentHash` connect `ContentHash` to `workers.rs`, `generations.rs`, `llama.rs`, `pool.rs`, `executor.rs`, `transfer.rs`, `mlx.rs`, `db/catalog.rs`, `capability.rs`, `backend/mod.rs`, `BackendError`, `TenantId`, `src/models.rs`, `schedule.rs`, `Candidate`, `Modality`, `PoolSupervisor`, `comfy/mod.rs`, `BackendKind`, `SchedulerHandle`, `ArtifactManifest`?**
  _High betweenness centrality (0.210) - this node is a cross-community bridge._
- **Why does `FailureKind` connect `executor.rs` to `record_accepted_result`, `generations.rs`, `comfy/mod.rs`, `gpq-worker/src/session.rs`, `openai/mod.rs`, `backend/mod.rs`, `parse_uuid_id`, `BackendError`, `attempts.rs`, `GenerationEvent`, `backend/comfy.rs`, `settle_attempt_failure`, `native/mod.rs`, `ExecutionContext`, `Modality`?**
